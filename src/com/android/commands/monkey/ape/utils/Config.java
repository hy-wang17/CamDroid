...
public class Config {
    ...
    public static final long defaultGUIThrottle = Config.getLong("ape.defaultGUIThrottle", 300L);
    ...
    public static final String loginPassword = Config.get("utb.loginPassword", "");
